...
\centering
\begin{tabular}{cc}
\includegraphics[width=3in]{images/mdp_distribution1_sampled_rademacher_k_750} &
\includegraphics[width=3in]{images/mdp_distribution2_sampled_rademacher_k_750}
\end{tabular}
